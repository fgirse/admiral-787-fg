...
export default function index() {
 ...
 `;
  ...
  return (
    <>
<Wrapper className=" w-[100vw] h-[100vh] relative flex flex-col item-center justify-start">
...
<BackgroundImage></BackgroundImage>
  ...
  <div className="mx-auto w-11/12 h-40"><h1 className="hidden lg:block p-2 text-center headingD absolute w-11/12 top-[-vh] text-3xl text-white xl:text-6xl font-bold">Dein Treffpunkt in Freiburg !!!</h1>
</div>
