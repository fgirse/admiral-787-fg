...
<div className="mt-4 flex flex-wrap -mx-24">
      ...
      <lr classname="w-9/12 text-red-400"/> 
       ...
       <h3 className="mt-3 text-5xl text-yellow-600 mb-2 font-bold font-heading">Anne</h3>
         ...
         <p className="mt-4 text-1xl xl: text-justify text-sm text-gray-300 leading-relaxed xl:text-xl ">Auch Anne ist Teammitglied derersten Stunde nach Stapelablauf des Rettungsanker-Mit Ihrer langjährigen Gastroerfahrung  ist sie ein wichtiger Pfeiler im Team des Rettungsankers</p>
       </div>
     </div>
</section>
 </div>
